![MornDesktopTube](design/ogp.png)
...
再生ボタン列の右にあるリピートアイコンをオンにすると、現在の動画を繰り返します（広告・ライブ配信を除く）。設定は次回起動時も保持されます。

最後に再生した動画を記憶し、次回起動時に背景で自動再生します。

背景表示中は操作バーと終了時のカウントダウンを隠します。リピートがオフで次の動画がある場合は、動画の終了後すぐに次へ進みます（読み込み時間は発生します）。
